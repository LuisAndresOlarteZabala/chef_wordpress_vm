...
describe 'lamp::lamp_ubuntu' do
  package_checks = {
    'ubuntu' => {
      '16.04' => ['apache2','mysql-server','php-mysql'],
      '18.04' => ['apache2','mysql-server','php-mysql'],
      '20.04' => ['apache2','mysql-server','php-mysql'],
    }
  }
      ...
      packages.each do |package_name|
        it "should install #{package_name} on #{platform} #{version}" do
          chef_run = ChefSpec::SoloRunner.new(platform: platform, version: version, file_cache_path: '/var/chef/cache') do |node|
            node.normal['lamp']['family'] = "ubuntu"
